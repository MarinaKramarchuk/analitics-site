...
export default function DateFilter({ startDate, endDate, onDateRangeChange }) {
  ...
  const renderCustomHeader = ({
    ...
    const monthTitle = date.toLocaleString("en-US", {
      month: "long",
      year: "numeric",
    });
    ...
    return (
      <div className="custom-datepicker-header">
        ...
        <span className="header-month-title">{monthTitle}</span>
        <button
          type="button"
